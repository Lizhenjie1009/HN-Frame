...
t.validate.max = 'Length should not be greater than'
t.validate.min = 'Length should not be less than'

t.sys = {}
t.sys.status0 = 'Pause'
t.sys.status1 = 'Normal'
...
t.login.demo = 'Demo'
t.login.copyright = 'Manager'

t.home = {}
t.home.sysInfo = {}
t.home.sysInfo.name = 'System Name'
t.home.sysInfo.nameVal = 'Front Manager'
...
t.graphinfo = {}
t.graphinfo.number = 'Number'
t.graphinfo.name = 'Name'
t.graphinfo.status = '状态'
t.graphinfo.status0 = '停用'
t.graphinfo.status1 = '正常'
t.graphinfo.pubStatus = "发布状态"
t.graphinfo.pubStatus0 = "未发布"
t.graphinfo.pubStatus1 = "已发布"
t.graphinfo.remark = '备注'
t.graphinfo.createDate = '创建时间'

t.relatype = {}
t.relatype.number = '序号'
t.relatype.name = '名称'
t.relatype.status = '状态'
t.relatype.status0 = '停用'
t.relatype.status1 = '正常'
t.relatype.remark = '备注'
t.relatype.createDate = '创建时间'
